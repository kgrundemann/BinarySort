...
import ElementsGeneratorScreen from "./screens/ElementsGeneratorScreen";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        />
        <Stack.Screen
          name="ElementsGeneratorScreen"
          component={ElementsGeneratorScreen}
          options={{ title: "Elements Generator" }}
        />
        <Stack.Screen
